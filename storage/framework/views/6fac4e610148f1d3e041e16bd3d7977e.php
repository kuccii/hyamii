        ...
        <div class="flex justify-between gap-3 my-4 space-y-1">
            <div class="inline-flex gap-4 table-display-container">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderDetail->order_type == 'dine_in'): ?>
                    <div id="table-info-section" style="display: <?php echo e($orderDetail->table ? 'flex' : 'none'); ?>;" class="inline-flex items-center gap-2">
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['p-3 rounded-lg tracking-wide bg-skin-base/[0.2] text-skin-base']); ?>">
                            <h3 class="<?php echo \Illuminate\Support\Arr::toCssClasses(['font-semibold']); ?>" id="table-code">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['onclick' => 'showTableChangeConfirmationModal()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'showTableChangeConfirmationModal()']); ?>
...
<?php endif; ?>
                    ...
                    <div id="set-table-section" style="display: <?php echo e($orderDetail->table ? 'none' : 'block'); ?>;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Update Order')): ?>
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['onclick' => 'showTableChangeConfirmationModal()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'showTableChangeConfirmationModal()']); ?><?php echo app('translator')->get('modules.order.setTable'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af)): ?>
<?php $attributes = $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af; ?>
<?php unset($__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af); ?>
...
<?php endif; ?>
                ...
                <?php else: ?>
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['p-3 rounded-lg tracking-wide bg-skin-base/[0.2] text-skin-base']); ?>">
                        <h3 class="<?php echo \Illuminate\Support\Arr::toCssClasses(['font-semibold']); ?>">
                            <?php echo e($orderDetail->table->table_code ?? '--'); ?>
                ...
                <div class="mt-2 customer-display-container">
                    <div id="customer-info-section" class="flex items-center gap-2" style="display: <?php echo e($orderDetail->customer ? 'flex' : 'none'); ?>;">
                        <div id="customer-name" class="font-semibold text-gray-700 dark:text-gray-300"><?php echo e($orderDetail->customer->name ?? ''); ?></div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Update Order')): ?>
                            <button id="edit-customer-btn" onclick="showAddCustomerModal(<?php echo e($orderDetail->customer_id ?? 'null'); ?>)" title="<?php echo e(__('modules.order.updateCustomerDetails')); ?>" class="p-1 text-gray-500 transition-colors bg-gray-100 rounded-md hover:text-gray-700 hover:bg-gray-200 rtl:ml-2 ltr:mr-2 dark:text-gray-300 dark:bg-gray-600 dark:hover:text-gray-200 dark:hover:bg-gray-700">
                    ...
                    <div id="add-customer-section" style="display: <?php echo e($orderDetail->customer ? 'none' : 'block'); ?>;">
                        <a href="javascript:;"
            ...
            <?php else: ?>
                <div class="flex flex-col space-y-4">
                    <div class="flex items-center justify-between text-gray-900 dark:text-white">
                        ...
                        <span id="order-status-badge" data-status="<?php echo e($orderDetail->order_status->value); ?>" class="px-3 py-1 text-sm font-medium rounded-full"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Update Order')): ?>
                        <div class="flex justify-end items-center mt-4 space-x-2 rtl:!space-x-reverse">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentIndex < count($statuses) - 1): ?>
                                <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['id' => 'order-status-next-btn','class' => 'inline-flex items-center gap-2','onclick' => 'updateOrderStatus(\''.e($statuses[$nextIndex]).'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'order-status-next-btn','class' => 'inline-flex items-center gap-2','onclick' => 'updateOrderStatus(\''.e($statuses[$nextIndex]).'\')']); ?>
                                    <span id="order-status-next-label"><?php echo e(__('modules.order.moveTo')); ?> <?php echo e(App\Enums\OrderStatus::from($statuses[$nextIndex])->translatedLabel()); ?></span>
...
<?php endif; ?>
        ...
        <div class="flex flex-col rounded ">
            <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" wire:key='menu-item-list-<?php echo e(microtime()); ?>'>
                    ...
                    ?>
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='menu-item-<?php echo e($key . microtime()); ?>' wire:loading.class.delay='opacity-10' data-order-item-id="<?php echo e($item->id); ?>">
                        <td class="flex flex-col p-2 mr-12 lg:min-w-28">
                            <div class="inline-flex items-center gap-2 text-xs text-gray-900 dark:text-white">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFreeItemFromStamp): ?>
                                ...
                                <?php elseif($hasStampDiscount): ?>
                                    <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300">
                                        <?php echo app('translator')->get('app.stampDiscount'); ?> (-<?php echo e(currency_format($stampDiscountAmount, restaurant()->currency_id)); ?>)
                                    </span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFreeItemFromStamp): ?>
                                <div class="flex flex-col items-end">
                                    ...
                                    <span class="text-[10px] text-gray-400 line-through">
                                        <?php echo e(currency_format($expectedAmount, restaurant()->currency_id)); ?>
                        ...
                        <td class="p-2 text-right whitespace-nowrap">
                            <button type="button" onclick="deleteOrderItem('<?php echo e($item->id); ?>')" class="p-2 text-gray-800 border rounded dark:text-gray-400 dark:border-gray-500 hover:bg-gray-200 dark:hover:bg-gray-900/20">
        ...
        <div>
            <div class="w-full h-auto p-4 mt-3 space-y-4 text-center rounded select-none bg-gray-50 dark:bg-gray-700">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($orderDetail->items) > 0 && $orderDetail->status !== 'paid' && user_can('Update Order')): ?>
                <div class="flex text-left">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Add Discount on POS')): ?>
                        <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['onclick' => 'showAddDiscountModal()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'showAddDiscountModal()']); ?>
...
<?php endif; ?>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div id="discount-row" class="flex justify-between text-sm text-green-500 dark:text-green-400" style="display: <?php echo e(($orderDetail->discount_amount ?? 0) > 0 && $orderDetail->loyalty_points_redeemed == 0 ? 'flex' : 'none'); ?>;">
                    <div class="inline-flex items-center gap-x-1">
                        <?php echo app('translator')->get('modules.order.discount'); ?>
                        <span id="discount-type-display">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderDetail->discount_type == 'percent'): ?>
                                (<?php echo e(rtrim(rtrim($orderDetail->discount_value), '.')); ?>%)
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Add Discount on POS') && user_can('Update Order')): ?>
                            <span class="text-red-500 cursor-pointer hover:scale-110 active:scale-100" onclick="removeCurrentDiscount()" title="<?php echo app('translator')->get('app.remove'); ?>">
                    ...
                    <div id="discount-display">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($orderDetail->discount_amount ?? 0) > 0): ?>-<?php echo e(currency_format($orderDetail->discount_amount, restaurant()->currency_id)); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400" data-charge-id="<?php echo e($charge->id); ?>">
                    <div class="inline-flex items-center gap-x-1"><?php echo e($charge->charge_name); ?>
                        ...
                        <span class="text-red-500 cursor-pointer hover:scale-110 active:scale-100"
                            onclick="removeExtraCharge(<?php echo e($charge->id); ?>, '<?php echo e($orderType); ?>')" title="<?php echo app('translator')->get('app.remove'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($taxMode == 'order'): ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="flex justify-between text-sm text-gray-500 dark:text-neutral-400">
                        <div><?php echo app('translator')->get('modules.order.totalTax'); ?></div>
                        <div id="order-detail-total-tax"><?php echo e(currency_format($orderDetail->total_tax_amount ?? 0, restaurant()->currency_id)); ?></div>
                    </div>
                <?php else: ?>
                    <?php
            ...
            <div class="w-full h-auto pt-3 pb-4 text-center select-none">
                <div class="flex gap-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($orderDetail->status, ['billed', 'payment_due']) && user_can('Update Order')): ?>
                    <button type="button" onclick="showPaymentModalForOrder(<?php echo e($orderDetail->id); ?>, this)" class="pos-order-action-btn w-full p-2 text-white bg-green-600 rounded">
                        <span data-btn-text><?php echo app('translator')->get('modules.order.addPayment'); ?></span>
                    ...
                    <button type="button" onclick="printOrder(<?php echo e($orderDetail->id); ?>, this)" class="pos-order-action-btn inline-flex items-center justify-center w-full p-2 mt-2 text-gray-800 border border-gray-300 rounded dark:border-gray-600 dark:text-gray-200 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 gap-x-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orderDetail->split_type && $orderDetail->splitOrders()->where('status', 'paid')->count() > 0): ?>
    ...
    <div id="confirmDeleteModal" style="display: none;" class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50">
        ...
        <div class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:max-w-2xl sm:mx-auto">
            ...
            <div class="space-y-6">
                ...
                <!-- Reason Selection -->
                 <div>
                <label for="cancelReason" class="text-sm font-medium text-gray-700 dark:text-gray-200"><?php echo e(__('modules.settings.selectCancelReason')); ?></label>
                <select id="cancelReason" class="block w-full mt-2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-skin-base focus:ring-skin-base rounded-md shadow-sm">
            ...
            <div class="px-6 py-4 bg-gray-100 dark:bg-gray-800 text-right">
                <button type="button" onclick="closeCancelOrderModal()" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-skin-base focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-25 transition ease-in-out duration-150">
        ...
        <div class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:max-w-md sm:mx-auto">
            <div class="px-6 py-4">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100"><?php echo app('translator')->get('modules.order.changeTable'); ?></h3>
                </div>
            </div>
            <div class="px-6 py-4">
            <div class="space-y-4">
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','onclick' => 'cancelTableChange()']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','onclick' => 'confirmTableChange()']); ?>
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/pos/order_detail.blade.php ENDPATH**/ ?>