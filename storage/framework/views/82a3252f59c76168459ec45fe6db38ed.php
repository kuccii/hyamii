<div>
    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="mb-4">
                <h1 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('modules.report.duePaymentsReceivedReport'); ?></h1>
            </div>
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/reports/due-payment-received-report.blade.php ENDPATH**/ ?>