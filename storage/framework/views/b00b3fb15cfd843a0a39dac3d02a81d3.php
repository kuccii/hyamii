<div x-data="{ mobileOpen: false }" class="lg:hidden">
    <nav class="py-3">
        <div class="flex items-center justify-between gap-2">
            <a href="<?php echo e(route('shop_restaurant', [$restaurant->hash]).'?branch=' . $shopBranch->id); ?>" wire:navigate class="flex items-center gap-2 min-w-0">
                <img src="<?php echo e($restaurant->logoUrl); ?>" class="h-8 w-8 rounded-lg object-cover ring-2 ring-white dark:ring-gray-800 shadow-sm flex-shrink-0" alt="" />
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->show_logo_text): ?>
                    <span class="text-base font-semibold text-gray-900 dark:text-white truncate"><?php echo e($restaurant->name); ?></span>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3987730485-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3987730485-1', $__key);
    ...
    <div x-show="mobileOpen" x-cloak
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-800">
            <div class="flex items-center gap-2.5">
                <img src="<?php echo e($restaurant->logoUrl); ?>" class="h-8 w-8 rounded-lg object-cover ring-2 ring-white dark:ring-gray-800 shadow-sm" alt="" />
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null(customer())): ?>
                        <p class="text-xs text-gray-500 dark:text-gray-400 truncate max-w-[160px]"><?php echo e(customer()->name); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3987730485-2', $__key);
...
?>
        ...
        <div class="flex-1 overflow-y-auto py-2">
            ...
            <ul class="space-y-0.5 px-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['condition']): ?>
                        <?php
                        ...
                        ?>
                        <li>
                            <a href="<?php echo e($routeUrl); ?>" wire:navigate @click="mobileOpen = false"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null(customer())): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showLoyaltyMenu): ?>
                    <div class="px-3 mt-2">
                        <a href="<?php echo e(route('loyalty.customer.account', [$restaurant->hash]).'?branch=' . $shopBranch->id); ?>" wire:navigate @click="mobileOpen = false"
                            ...
                            <span><?php echo app('translator')->get('loyalty::app.myLoyaltyAccount'); ?></span>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
</div><?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/shop-navigation.blade.php ENDPATH**/ ?>