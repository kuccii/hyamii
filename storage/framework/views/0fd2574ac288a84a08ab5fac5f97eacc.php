<div>
     ...
     <div class="bg-white rounded-xl border border-gray-100 p-5 cursor-pointer dark:bg-gray-800 dark:border-gray-700">
        <div class="flex items-center justify-between mb-3">
          <p class="text-sm font-medium text-gray-700 dark:text-white"><?php echo app('translator')->get('modules.order.todayOrder'); ?></p>
          <span class="text-[11px] text-gray-400 dark:text-white"><?php echo e($orders->count()); ?> <?php echo app('translator')->get('modules.order.total'); ?></span>
        </div>
        <div class="space-y-0">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!user()->hasRole('Waiter_' . user()->restaurant_id)): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $waiterOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                    ...
                    <?php endif; ?>
                    class="flex items-center gap-2.5 py-2.5 border-b border-gray-50 dark:border-gray-500" wire:key='order-item-<?php echo e($order->id . microtime()); ?>' href="javascript:;">
                        ...
                        <p class="text-[13px] font-medium text-gray-800 truncate"><?php echo e($order->customer ? ($order->customer->name ? $order->customer->name : __('modules.customer.walkin')) : '--'); ?></p>
                        ...
                        <p class="text-[13px] font-medium text-gray-800"><?php echo e(currency_format($order->display_total ?? $order->total ?? 0, restaurant()->currency_id)); ?></p>
                            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-[10px] px-2 py-0.5 rounded-full',
                             'text-yellow-500 bg-yellow-100' => $order->order_status->value == 'placed',
                             'text-yellow-600 bg-yellow-100' => $order->order_status->value == 'confirmed',
                             'text-skin-secondary bg-skin-secondary/10' => $order->order_status->value == 'preparing',
                            ...
                            'text-red-500 bg-red-100' => $order->order_status->value == 'cancelled',]); ?>"><?php echo app('translator')->get('modules.order.info_' . $order->order_status->value); ?></span>
                            </span>
                        </div>
                    </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                        ...
                        <?php else: ?>
                            wire:click="$dispatch('showOrderDetail', { id: <?php echo e($order->id); ?> })"
                        <?php endif; ?>
                        class="flex items-center gap-2.5 py-2.5 border-b border-gray-50" wire:key='order-item-<?php echo e($order->id . microtime()); ?>' href="javascript:;">
                        <div class="w-7 h-7 rounded-lg bg-skin-base/[0.2] text-skin-base flex items-center justify-center text-[11px] font-semibold shrink-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->order_type == 'pickup'): ?>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-bag-fill" viewBox="0 0 16 16">
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/dashboard/today-order-list.blade.php ENDPATH**/ ?>