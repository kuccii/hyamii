  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center justify-start">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="flex ltr:ml-2 rtl:mr-2 items-center app-logo gap-2 min-w-fit">
          <img src="<?php echo e(restaurant()->logoUrl); ?>" class="h-7 w-7 ltr:mr-1 sm:ltr:mr-2 rtl:ml-1 sm:rtl:ml-2 shrink-0" alt="" />
          ...
          <span class="self-center text-md font-semibold whitespace-nowrap dark:text-white hidden lg:block ltr:mr-2 rtl:ml-2 truncate max-w-[45vw]"><?php echo e(Str::limit(restaurant()->name, 10)); ?></span>
          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </a>
        ...
        <div class="flex gap-2">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('Order', restaurant_modules()) && (request()->routeIs('pos.*') || (user_can('Show Order') && restaurant()->hide_new_orders == 0))): ?>
            <?php
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2381999341-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2381999341-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2381999341-2', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2381999341-3', $__key);
...
?>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('pos.*')): ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-skin-base border-skin-base border hover:bg-skin-base/[.8] rounded-md ltr:mr-2 rtl:ml-2 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-800 dark:text-gray-300 gap-1">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2381999341-4', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2381999341-5', $__key);
...
[$__name, $__params] = $__split('restaurant.restaurantOpenCloseToggle');

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2381999341-6', $__key);
...
<?php endif; ?>
        ...
        <?php elseif(restaurant()->package->package_type == \App\Enums\PackageType::TRIAL): ?>
            ...
            <a href="<?php echo e(route('pricing.plan')); ?>" wire:navigate class="hidden md:block inline-flex" data-tooltip-target="trial-tooltip-toggle" data-tooltip-placement="bottom">
                <button aria-label="<?php echo e($trialText); ?>">
                    <svg class="w-5 h-5 text-current group-hover:scale-110 duration-500 sm:hidden" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                        <path d="M3 7a2 2 0 0 1 2-2h2.586l1.707-1.707A1 1 0 0 1 10 3h4a1 1 0 0 1 .707.293L16.414 5H19a2 2 0 0 1 2 2v2H3V7Zm0 4h18v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7Zm8 2v4a1 1 0 1 0 2 0v-4a1 1 0 1 0-2 0Z"/>
                    </svg>
                    <span class="hidden sm:inline text-xs px-3 py-1.5 rounded-full font-medium bg-amber-50 text-amber-700 border border-amber-200"><?php echo e($trialText); ?></span>
                </button>
            </a>
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/navigation-menu.blade.php ENDPATH**/ ?>