...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1705652167-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1705652167-1', $__key);
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 py-10">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e($restaurant->logoUrl); ?>" class="h-8 w-8 rounded-lg object-cover" alt="<?php echo e($restaurant->name); ?>" />
                        <div>
                            <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($restaurant->name); ?></p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">&copy; <?php echo e(now()->year); ?> <?php echo app('translator')->get('app.allRightsReserved'); ?></p>
                        </div>
                    </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1705652167-2', $__key);
...
?>
                        ...
                        <div class="flex items-center gap-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->facebook_link): ?>
                                <a href="<?php echo e($restaurant->facebook_link); ?>" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all" aria-label="Facebook">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->instagram_link): ?>
                                <a href="<?php echo e($restaurant->instagram_link); ?>" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all" aria-label="Instagram">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->twitter_link): ?>
                                <a href="<?php echo e($restaurant->twitter_link); ?>" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all" aria-label="Twitter">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->yelp_link): ?>
                                <a href="<?php echo e($restaurant->yelp_link); ?>" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all" aria-label="Yelp">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->google_business_link): ?>
                                <a href="<?php echo e($restaurant->google_business_link); ?>" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all" aria-label="Google">
                ...
                instructions.innerHTML = `
                    <div style="position: fixed; bottom: 10px; left: 10px; right: 10px; background: #fff; padding: 10px; border: 1px solid #ccc; border-radius: 5px; text-align: center; z-index: 1000;">
                        <p class="flex items-center justify-center gap-2 m-0">
                            <?php echo app('translator')->get('messages.installAppInstruction'); ?>
                            <img class="ml-2" src="<?php echo e(asset('img/share-ios.svg')); ?>" alt="Share Icon" style="width: 20px; vertical-align: middle;">
                        </p>
...
</html><?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/layouts/guest.blade.php ENDPATH**/ ?>