...
<div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
    ...
    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['group flex flex-col gap-2.5 items-stretch w-full focus:outline-none focus-visible:ring-2 focus-visible:ring-skin-base/60 rounded-xl']); ?>"
        <?php if($order->status == 'kot'): ?>
            href="<?php echo e(route('pos.kot', $order->id).'?show-order-detail=true'); ?>"
        <?php elseif($order->status == 'draft'): ?>
            href="<?php echo e(route('pos.draft', $order->id)); ?>"
        <?php else: ?>
        ...
        <div class="flex flex-col sm:flex-row gap-3.5 sm:gap-4 sm:justify-between w-full min-w-0">
            <div class="flex gap-3 min-w-0 flex-1">
                ...
                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    ...
                    <h3 wire:loading.class.delay='opacity-50' class="<?php echo \Illuminate\Support\Arr::toCssClasses(['font-semibold text-sm leading-none']); ?>">
...
'text-yellow-600' => $order->order_status->value == 'confirmed',
                             'text-skin-secondary' => $order->order_status->value == 'preparing',
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($order->waiter_response) && $order->waiter_id): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(user_can('Update Order')): ?>
            <div onclick="event.stopPropagation();" class="flex-shrink-0 mt-2">
                <form method="POST" action="<?php echo e(route('orders.waiter.status', $order->uuid)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="relative inline-flex items-center">
                        <select
                            ...
                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                'transition focus:outline-none focus:ring-2 focus:ring-skin-base focus:ring-offset-1 focus:ring-offset-white dark:focus:ring-offset-gray-900',
                        ...
                        >
                            <option value="pending" <?php if($order->waiter_response === 'pending'): echo 'selected'; endif; ?>>
                                <?php echo app('translator')->get('app.waiterResponse_pending'); ?>
                            </option>
                            <option value="accepted" <?php if($order->waiter_response === 'accepted'): echo 'selected'; endif; ?>>
                                <?php echo app('translator')->get('app.waiterResponse_accepted'); ?>
                            </option>
                            <option value="declined" <?php if($order->waiter_response === 'declined'): echo 'selected'; endif; ?>>
                                <?php echo app('translator')->get('app.waiterResponse_declined'); ?>
                            </option>
                        </select>
        ...
        <?php else: ?>
            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                ...
                <?php echo app('translator')->get('app.waiterResponse_' . $order->waiter_response); ?>
            </span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showTrackButton && $trackEndpoint): ?>
        <div class="w-full mt-2">
            <button type="button"
                x-on:click.prevent.stop="openTrackModal(<?php echo \Illuminate\Support\Js::from($trackEndpoint)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($trackOrderLabel ?? ('#' . $order->show_formatted_order_number))->toHtml() ?>)"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showLiveBlink): ?>
                    ...
                    <span class="text-[10px] font-semibold uppercase tracking-wide"><?php echo app('translator')->get('app.liveStatus'); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php echo app('translator')->get('app.track'); ?>
            </button>
        </div>
    <?php elseif($showDeliveredButton): ?>
        <div class="w-full mt-2">
            <button type="button"
                ...
                <?php echo app('translator')->get('app.delivered'); ?>
            </button>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/components/order/order-card.blade.php ENDPATH**/ ?>