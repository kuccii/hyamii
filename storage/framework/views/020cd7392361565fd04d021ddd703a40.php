<div>
    ...
    <div class="w-full">
        <h3 class="text-sm font-medium text-gray-700 mb-3 dark:text-gray-400"><?php echo app('translator')->get('modules.order.paymentMethod'); ?> (<?php echo app('translator')->get('app.today'); ?>)
        </h3>
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/dashboard/today-payment-method-earnings.blade.php ENDPATH**/ ?>