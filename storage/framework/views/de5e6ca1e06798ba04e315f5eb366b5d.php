            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (backupOption === 'create_backup') {
                        ...
                        $.easyAjax({
                            type: 'POST',
                            url: '<?php echo route("admin.updateVersion.createBackup"); ?>',
                            data: {
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/vendor/froiden-envato/update/update_script.blade.php ENDPATH**/ ?>