    ...
    <div>
        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                <div class="mb-4">
                    <h1 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('menu.deliveryExecutive'); ?></h1>
                </div>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e($executiveSiteUrl); ?>" target="_blank"
                            class="inline-flex items-center justify-center cursor-pointer w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                            ...
                            <?php echo app('translator')->get('menu.openExecutiveSite'); ?>
                        </a>
...
$__key = 'executive-table-'.e(microtime()).'';

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2350250424-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2350250424-1', $__key);
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/delivery-executive/delivery-executive-list.blade.php ENDPATH**/ ?>