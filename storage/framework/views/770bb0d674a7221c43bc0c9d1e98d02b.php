                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->deliveryExecutive): ?>
                                        <div
                                            ...
                                            <div class="flex items-center gap-2 text-sm">
                                                <span><?php echo e($order->deliveryExecutive->name); ?></span>
                                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                    ...
                                                    <?php echo e((bool) $order->deliveryExecutive->is_online ? __('app.online') : __('app.offline')); ?>
...
<?php endif; ?>
                                        <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                            <?php echo app('translator')->get('modules.order.onlyOnlineDeliveryExecutivesShown'); ?>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!user()->hasRole('Waiter_' . user()->restaurant_id) && $order->order_type == 'dine_in'): ?>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->placed_via): ?>
                            <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                ...
                                'text-skin-base bg-skin-base/10 dark:bg-skin-base/20 dark:text-skin-base border border-skin-base/30' => $order->placed_via === 'pos',
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'createKot','wire:loading.attr' => 'disabled','wire:target' => 'createKot','class' => 'flex-shrink-0 text-xs whitespace-nowrap']); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order): ?>
                ...
                <div>
                    <div
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($order->items) > 0 && user_can('Update Order') && $order->status !== 'paid'): ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!is_null($order->discount_amount) && $order->loyalty_points_redeemed == 0): ?>
                            <div wire:key="discountAmount" class="flex justify-between text-sm text-green-500 dark:text-green-400">
                                <div class="flex items-center gap-x-1">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->discount_amount > 0 && user_can('Update Order') && $order->status !== 'paid'): ?>
                    ...
                    <div class="w-full h-auto pt-3 pb-4 select-none">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cashCollection): ?>
                            <?php
                            ...
                            <div class="mb-3 rounded-xl border p-4 <?php echo e($bannerClasses); ?>">
                                <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                    <div>
                                        <div class="text-sm font-semibold <?php echo e($titleClasses); ?>">
                                            <?php echo app('translator')->get($isCustomerPaid ? 'modules.delivery.customerPaymentCollected' : 'modules.delivery.customerPaymentPending'); ?>
                                        </div>
                                        <div class="mt-1 text-sm <?php echo e($descriptionClasses); ?>">
                                    ...
                                    <div class="sm:text-right">
                                        <div class="text-xs font-medium uppercase tracking-wide <?php echo e($labelClasses); ?>">
                                            <?php echo app('translator')->get('modules.delivery.executiveCollectionStatus'); ?>
                                        </div>
                                        <div class="mt-1 inline-flex items-center rounded-full border px-3 py-1 text-sm font-semibold <?php echo e($badgeClasses); ?>">
                                            <?php echo e(match ($cashCollectionStatus) {
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-link','data' => ['wire:click' => 'printOrder('.e($order->id).')','target' => '_blank','wire:key' => 'print-payment-button','class' => 'min-h-[50px] cursor-pointer rounded-xl bg-white hover:bg-gray-50 text-gray-700 border p-3 inline-flex flex-col items-center justify-center gap-1 transition-colors dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'printOrder('.e($order->id).')','target' => '_blank','wire:key' => 'print-payment-button','class' => 'min-h-[50px] cursor-pointer rounded-xl bg-white hover:bg-gray-50 text-gray-700 border p-3 inline-flex flex-col items-center justify-center gap-1 transition-colors dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700']); ?>
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor"
                                    ...
                                    <span class="text-sm font-medium">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->split_type && $order->splitOrders->count() > 0): ?>
                                            <?php echo app('translator')->get('modules.order.printSplits'); ?>
                                        <?php else: ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->payments->count()): ?>
                    <div class="flex flex-col rounded">
                        <table class="flex-1 min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700"
                                wire:key='menu-order-payments-<?php echo e(microtime()); ?>'>
...
[$__name, $__params] = $__split('pos.setTable', ['targetEvent' => 'setOrderDetailTable']);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3444498488-0', $__key);
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal49bd1c1dd878e22e0fb84faabf295a3f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal49bd1c1dd878e22e0fb84faabf295a3f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dialog-modal','data' => ['wire:model.live' => 'showPrintOptionsModal','maxWidth' => '2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dialog-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'showPrintOptionsModal','maxWidth' => '2xl']); ?>
         <?php $__env->slot('title', null, []); ?> 
         ...
         <?php $__env->slot('content', null, []); ?> 
            <div class="space-y-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($printMode === 'single'): ?>
                    <!-- Single Split Selection View -->
                    <div class="space-y-3">
                        <?php if (isset($component)) { $__componentOriginala6c1b2378c7a756a2b58951b1494d68f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala6c1b2378c7a756a2b58951b1494d68f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-link','data' => ['wire:click' => '$set(\'printMode\', null)','class' => 'flex items-center gap-2 pb-3 border-b border-gray-200 dark:border-gray-700 rounded-lg px-2 py-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer select-none transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$set(\'printMode\', null)','class' => 'flex items-center gap-2 pb-3 border-b border-gray-200 dark:border-gray-700 rounded-lg px-2 py-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer select-none transition-colors']); ?>
                            ...
                            <span class="text-base font-semibold text-gray-900 dark:text-white tracking-tight">
                                <?php echo app('translator')->get('modules.order.selectGuest'); ?>
                            </span>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala6c1b2378c7a756a2b58951b1494d68f)): ?>
...
<?php endif; ?>
                        ...
                        <div class="space-y-2 max-h-96 overflow-y-auto">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->splitOrders->where('status', 'paid'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $split): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer transition-all hover:bg-gray-50 dark:hover:bg-gray-700 <?php echo e($selectedSplitId == $split->id ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-600'); ?>">
                                    <input type="radio" wire:model.live="selectedSplitId" value="<?php echo e($split->id); ?>" class="w-4 h-4 text-blue-600 focus:ring-blue-500 dark:focus:ring-blue-600">
                                    <div class="flex items-center justify-between flex-1 ml-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div class="text-sm font-semibold text-gray-900 dark:text-white">
                                                    <?php echo app('translator')->get('modules.order.guest'); ?> #<?php echo e($index + 1); ?>

                                                </div>
                                                <div class="text-xs text-gray-600 dark:text-gray-400">
                                                    <?php echo e(__('modules.order.' . $split->payment_method)); ?>
                                        ...
                                        <div class="text-right">
                                            <div class="text-sm font-bold text-gray-900 dark:text-white">
                                                <?php echo e(currency_format($split->amount, $currencyId)); ?>
                        ...
                        <div class="flex justify-end gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                            <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.secondary-button','data' => ['wire:click' => '$set(\'showPrintOptionsModal\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('secondary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$set(\'showPrintOptionsModal\', false)']); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'printSingleSplit','class' => 'bg-skin-base hover:bg-skin-base/80']); ?>
                                ...
                                <?php echo app('translator')->get('modules.order.printSelected'); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale67687e3e4e61f963b25a6bcf3983629)): ?>
<?php $attributes = $__attributesOriginale67687e3e4e61f963b25a6bcf3983629; ?>
                    ...
                    <button wire:click="handlePrintOption('all')" class="w-full flex items-start gap-4 p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all group">
                        ...
                        <div class="flex-1 text-left">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                <?php echo app('translator')->get('modules.order.printAllDesc', ['count' => $order->splitOrders->where('status', 'paid')->count() + 1]); ?>
                            </p>
                        </div>
...
<button wire:click="handlePrintOption('individual')" class="w-full flex items-start gap-4 p-4 border-2 border-gray-200 dark:border-gray-600 rounded-lg hover:border-skin-secondary hover:bg-gray-50 dark:hover:bg-gray-700 transition-all group">
                        ...
                        <div class="flex-1 text-left">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                <?php echo app('translator')->get('modules.order.individualOnlyDesc', ['count' => $order->splitOrders->where('status', 'paid')->count()]); ?>
                            </p>
                        </div>
         ...
         <?php $__env->slot('title', null, []); ?> 
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400"><?php echo app('translator')->get('modules.order.cancelOrderMessageUndone'); ?></p>
                </div>
            </div>
         <?php $__env->endSlot(); ?>
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/order/order-detail.blade.php ENDPATH**/ ?>