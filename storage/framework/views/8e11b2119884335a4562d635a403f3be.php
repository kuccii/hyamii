<div <?php if(!pusherSettings()->is_enabled_pusher_broadcast && $pollingEnabled): ?> wire:poll.<?php echo e($pollingInterval); ?>s <?php endif; ?>>
    <div class="p-4 bg-white block  dark:bg-gray-800 dark:border-gray-700">
        <div class="flex mb-4">
            <h1 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('menu.waiterRequest'); ?> (<?php echo e($tables->sum(function($area) { return $area->tables->count(); })); ?>)</h1>
...
<?php endif; ?>
     ...
     <script>
        ...
        function bootWaiterRequestsRealtime() {
            wire = window.Livewire.find('<?php echo e($_instance->getId()); ?>');
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/waiter-request/tables.blade.php ENDPATH**/ ?>