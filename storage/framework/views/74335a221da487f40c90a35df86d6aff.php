...
<a href="<?php echo e(route('orders.index')); ?>" wire:navigate wire:key="today-orders-link"
    class="<?php echo e(request()->routeIs('pos.*') ? 'inline-flex' : 'hidden lg:inline-flex'); ?> items-center px-2 py-1 group text-sm font-medium text-center text-gray-600 bg-white border-skin-base border rounded-md focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-800 dark:text-gray-300"
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/dashboard/today-orders.blade.php ENDPATH**/ ?>