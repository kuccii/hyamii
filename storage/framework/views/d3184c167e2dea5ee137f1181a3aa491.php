<div x-data="{ addReservationOpen: false, openAddReservation() { this.addReservationOpen = true }, closeAddReservation() { this.addReservationOpen = false } }">
    ...
    <div class="p-4 bg-white block  dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-4">
            <h1 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo app('translator')->get('menu.reservations'); ?></h1>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isRestaurantOpenForReservations): ?>
...
$__key = 'reservation-' . $item->id
                    . microtime();

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3431855623-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3431855623-1', $__key);
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/reservations/reservations.blade.php ENDPATH**/ ?>