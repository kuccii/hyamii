            ...
            $.easyAjax({
                ...
                success: function(response) {
                    if (response.status === 'fail') {
                        ...
                        Swal.fire({
                            title: "Are you sure?",
                            html: `<?php if (isset($component)) { $__componentOriginalb5e767ad160784309dfcad41e788743b = $component; } ?>
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/vendor/froiden-envato/update/update_module.blade.php ENDPATH**/ ?>