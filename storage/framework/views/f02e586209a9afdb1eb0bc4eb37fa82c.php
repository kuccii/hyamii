    ...
    <nav class="py-3">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-8">
                <a href="<?php echo e(route('shop_restaurant', [$restaurant->hash]) . '?branch=' . $shopBranch->id); ?>" wire:navigate
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($restaurant->show_logo_text): ?>
                        <span class="text-base font-semibold text-gray-900 dark:text-white"><?php echo e($restaurant->name); ?></span>
                ...
                <div class="flex items-center">
                    <ul class="flex items-center gap-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['condition']) && !$item['condition']): ?>
                                <?php continue; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php
                            ...
                            ?>
                            <li>
                                <a href="<?php echo e(route($item['route'], [$restaurant->hash]) . '?branch=' . $shopBranch->id); ?>" wire:navigate
                                    ...
                                    <?php echo app('translator')->get($item['label']); ?>
                                </a>
                            </li>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3350180328-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3350180328-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3350180328-2', $__key);
...
?>
                ...
                <a href="javascript:;" wire:click="$dispatch('showCartItems')"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($orderItemCount) && $orderItemCount > 0): ?>
                        <div class="absolute inline-flex items-center justify-center w-4 h-4 text-[10px] font-bold text-white bg-gray-900 dark:bg-white dark:text-gray-900 rounded-full -top-0.5 -right-0.5 shadow-sm">
                            <?php echo e($orderItemCount > 99 ? '99+' : $orderItemCount); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </a>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_null(customer()) && $restaurant->customer_login_required): ?>
                    <button type="button" wire:click="$dispatch('showSignup')"
                        ...
                        style="background-color: rgb(<?php echo e($restaurant->theme_rgb); ?>); color: white;">
                        ...
                        <div x-show="accountOpen" x-cloak x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-1"
                            ...
                            <div class="p-2">
                                <div class="px-3 py-2 mb-1 border-b border-gray-100 dark:border-gray-800">
                                    <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e(customer()->name); ?></p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e(customer()->email ?? customer()->mobile ?? ''); ?></p>
                                </div>
...
</header><?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/livewire/shop-desktop-navigation.blade.php ENDPATH**/ ?>