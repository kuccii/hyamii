...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'products-search','class' => 'block w-full pl-10 pr-10 py-2 border-gray-200 rounded-lg text-sm focus:ring-skin-base focus:border-skin-base','type' => 'text','placeholder' => ''.e(__('placeholders.searchMenuItems')).'','value' => ''.e($search).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'products-search','class' => 'block w-full pl-10 pr-10 py-2 border-gray-200 rounded-lg text-sm focus:ring-skin-base focus:border-skin-base','type' => 'text','placeholder' => ''.e(__('placeholders.searchMenuItems')).'','value' => ''.e($search).'']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'products-search-clear','type' => 'button','onclick' => 'clearSearch()','class' => 'absolute  '.e(empty($search) ? 'hidden' : '').'','aria-label' => ''.e(__('app.reset')).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-link','data' => ['href' => ''.e(route('pos.index')).'','class' => 'inline-flex items-center px-3 py-2 gap-1 text-sm whitespace-nowrap']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('pos.index')).'','class' => 'inline-flex items-center px-3 py-2 gap-1 text-sm whitespace-nowrap']); ?>
...
<?php endif; ?>
                                ...
                                <div class="relative">
                                    ...
                                    <select id="menu-filter" onchange="filterByMenu(this.value)" class="block w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 focus:ring-skin-base focus:border-skin-base">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($menu->id); ?>" <?php echo e($menuId == $menu->id ? 'selected' : ''); ?>>
                            ...
                            <template x-if="filterView === 'grid'">
                                <div class="flex gap-2 items-center flex-wrap">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <button type="button"
                                            onclick="filterByMenu(<?php echo e($menu->id); ?>)"
                                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                'px-3 py-1.5 text-xs rounded-lg border transition text-left',
                            ...
                            <template x-if="filterView === 'select'">
                                <div class="relative">
                                    ...
                                    <select id="category-filter" onchange="filterByCategory(this.value)" class="block w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 focus:ring-skin-base focus:border-skin-base">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categoryList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php echo e($filterCategories == $category->id ? 'selected' : ''); ?>>
            ...
            <div
                ...
                x-data="{
                    loadedCount: <?php echo e($menuItemsLoaded); ?>,
                    totalCount: <?php echo e($totalMenuItemsCount); ?>,
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="menu-card bg-white rounded-xl border border-gray-100 overflow-hidden cursor-pointer group dark:border-gray-700">
                            <input type="checkbox" id="item-<?php echo e($item->id); ?>" value="<?php echo e($item->id); ?>"
                                onclick="addCartItemClientSide(<?php echo e($item->id); ?>)"
                                data-item-id="<?php echo e($item->id); ?>"
                                data-item-name="<?php echo e($item->item_name); ?>"
                                data-item-price="<?php echo e($item->price); ?>"
                                data-item-image="<?php echo e($item->item_photo_url); ?>"
                                data-item-taxes="<?php echo e(e(json_encode(($item->taxes ?? collect())->map(fn($tax) => ['id' => $tax->id, 'tax_name' => $tax->tax_name, 'tax_percent' => $tax->tax_percent])->values()->toArray()))); ?>"
                                data-variations-count="<?php echo e($item->variations_count); ?>"
                                data-modifiers-count="<?php echo e($item->modifier_groups_count); ?>"
                                data-item-in-stock="<?php echo e($item->in_stock ? '1' : '0'); ?>"
                                <?php echo e(($orderLimitReached || !$item->in_stock) ? 'disabled' : ''); ?>
                        ...
                        >
                                    ...
                                    <div id="loading-<?php echo e($item->id); ?>" class="absolute inset-0 bg-white/80 dark:bg-gray-800/80 rounded-lg z-10 items-center justify-center hidden">
                ...
                <div class="flex items-center justify-center py-6 px-4">
                    ...
                    <div id="menu-all-loaded" class="flex items-center gap-x-1 text-gray-500 dark:text-gray-400 <?php echo e($menuItemsLoaded >= $totalMenuItemsCount ? '' : 'hidden'); ?>">
...
<script>
    ...
    window.menuFilters = {
        ...
        limit: parseInt(urlParams.get('limit')) || <?php echo e($menuItemsLoaded); ?>
    ...
    window.menuFilters = window.menuFilters || {
        ...
        categoryId: null,
        search: '',
        limit: <?php echo e($menuItemsLoaded); ?>
    ...
    window.loadMenuItems = function() {
        ...
        $.easyAjax({
            url: "<?php echo e(route('ajax.pos.items')); ?>",
            type: "GET",
            data: {
    ...
    window.renderMenuItems = function(items, totalCount, loadedCount) {
        ...
        const hideImage = <?php echo e($restaurant->hide_menu_item_image_on_pos ? 'true' : 'false'); ?>;
        const currencyId = <?php echo e($restaurant->currency_id ?? 'null'); ?>;
                    ...
                    <label for="item-${item.id}" class="${labelClasses}" tabindex="${orderLimitReached ? '-1' : '0'}">
                        ...
                        <div class="relative aspect-square hidden md:block">
                            <img class="w-full lg:w-32 lg:h-32 object-cover select-none rounded-t-lg"
                                ...
                                alt="${itemName}" />
                            <span class="absolute top-1 right-1 bg-white/90 dark:bg-gray-800/90 rounded-full p-1 shadow-sm">
                                <img src="<?php echo e(asset('img/${itemType}.svg')); ?>"
    ...
    window.loadMoreMenuItems = function() {
        ...
        window.menuFilters.limit = (window.menuFilters.limit || <?php echo e($menuItemsLoaded); ?>) + <?php echo e($menuItemsLoaded); ?>;
    ...
    window.updateCategoryCounts = function() {
        ...
        $.easyAjax({
            url: "<?php echo e(route('ajax.pos.categories')); ?>",
            type: "GET",
            data: {
                menu_id: window.menuFilters.menuId,
                search: window.menuFilters.search,
            ...
            success: function(response) {
                if (response && Array.isArray(response)) {
                    ...
                    if ($select.length) {
                        ...
                        let html = '<option value=""><?php echo e(__('app.filterByCategory')); ?></option>';
...
<?php /**PATH C:\xamp\htdocs\Hyamii\resources\views/pos/menu.blade.php ENDPATH**/ ?>