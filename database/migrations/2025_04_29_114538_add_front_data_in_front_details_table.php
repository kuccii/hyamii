    ...
    public function up(): void
    {
        ...
        foreach ($activeLanguages as $languageSetting) {
            ...
            FrontDetail::create([
                ...
                'footer_copyright_text' => '© 2025 Hyamii. All Rights Reserved.',
                'created_at' => now(),
                'updated_at' => now(),
            ]);
            ...
            FrontFaq::insert([
                ...
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => 'Can I manage multiple locations with Hyamii?',
                    'answer' => 'Yes, Hyamii allows you to manage multiple restaurant locations from a single dashboard.',
                ],
                [
                    'language_setting_id' => $languageSetting->id,
                    'question' => 'Does Hyamii support online payments?',
                    'answer' => 'Absolutely. Hyamii integrates with leading payment gateways like Stripe and Razorpay for secure transactions.',
                ],
                [
                    'language_setting_id' => $languageSetting->id,
