...
<div class="payment_methods">
    ...
    @if($showOnline && $paymentGatewayActive)
        <div class="grid items-baseline grid-cols-1 gap-4 space-y-4 md:grid-cols-3">
            @if($stripeSettings->stripe_status === 1)
                <button wire:click="initiateStripePayment({{ $selectedPlan?->id }})" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->razorpay_status === 1)
                <button wire:click="razorpaySubscription({{ $selectedPlan?->id }});" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->flutterwave_status === 1)
                <button wire:click="initiateFlutterwavePayment({{ $selectedPlan?->id }});" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->paypal_status === 1)
                <button wire:click="initiatePaypalPayment({{ $selectedPlan?->id }});" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->payfast_status === 1)
                <button wire:click="initiatePayfastPayment({{ $selectedPlan?->id }});" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->paystack_status === 1)
                <button wire:click="initiatePaystackPayment({{ $selectedPlan?->id }});" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->xendit_status === 1)
                <button wire:click="initiateXenditPayment({{ $selectedPlan?->id }});" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->paddle_status === 1)
                <button
                    ...
                    class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn"
                >
            ...
            @if($stripeSettings->mollie_status === 1)
                <button wire:click="initiateMolliePayment" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($stripeSettings->tap_status === 1)
                <button wire:click="initiateTapPayment" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn">
            ...
            @if($offlinePaymentGateways > 0)
                <button wire:click="togglePaymentOptions('0')" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn gap-x-1">
    ...
    @if(!$showOnline && $offlinePaymentGateways > 0)
        @if($paymentGatewayActive)
            <button wire:click="togglePaymentOptions('1')" class="flex items-center w-full px-4 py-3 border rounded btn-light hover:shadow hover:bg-gray-50 dark:hover:bg-gray-500 f-15 btn gap-x-1">
        ...
        <div class="grid grid-cols-1 gap-6 mt-6">
            @foreach($methods as $method)
                <label class="relative flex flex-col gap-4 px-4 py-3 text-gray-700 transition bg-white border border-gray-200 rounded-md shadow dark:bg-gray-700 hover:border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 focus-within:ring-2 focus-within:ring-skin-base peer-checked:border-skin-base peer-checked:bg-skin-base/10 dark:peer-checked:text-gray-200">
