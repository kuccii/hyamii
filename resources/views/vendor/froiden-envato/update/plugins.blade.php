    ...
    <div class="w-full px-4 py-8">
        ...
        <div class="grid grid-cols-1 gap-4">
            @foreach ($notInstalledModules as $item)
                <div class="bg-white border rounded-lg p-4 @if (stripos($item['product_name'], 'universal') !== false) border-skin-base @endif relative">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="text-lg font-medium text-gray-900">
                                <a href="{{ $item['product_link'] }}" target="_blank" class="hover:text-skin-base">
                                    {{ $item['product_name'] }}
                                </a>
                            </h3>
