...
:class="darkMode ? 'bg-skin-base hover:bg-skin-base/[.8]' : 'bg-skin-base hover:bg-skin-base/[.8]'">
                     <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                         <svg class="h-5 w-5 theme-transition" :class="darkMode ? 'text-white' : 'text-white'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
