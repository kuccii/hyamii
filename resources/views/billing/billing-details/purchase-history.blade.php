                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='invoice-{{ $invoice->id . rand(1111, 9999) . microtime() }}' wire:loading.class.delay='opacity-10'>
                            <td class="py-2.5 px-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <span class="bg-skin-base text-white inline-flex text-xs font-medium items-center px-1 rounded gap-x-0.5 dark:bg-skin-base border border-skin-base">
                            ...
                            <td class="py-2.5 px-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $invoice->pay_date ? $invoice->pay_date->translatedFormat('D') . ', ' . $invoice->pay_date->format(dateFormat()) : '--' }}
                            </td>
                            <td class="py-2.5 px-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $invoice->next_pay_date ? $invoice->next_pay_date->translatedFormat('D') . ', ' . $invoice->next_pay_date->format(dateFormat()) : '--' }}
                            </td>
                            <td class="py-2.5 px-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
