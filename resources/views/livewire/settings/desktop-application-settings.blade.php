            ...
            <div class="card">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="mb-6 flex flex-col md:flex-row gap-6">
                        <!-- Hyamii Desktop App Preview -->

                                    <img src="{{ asset('img/icon.png') }}" alt="Hyamii Desktop Printing App" class="w-14 h-14 object-contain">

                                <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Hyamii Desktop Printing App</h3>

                                <p class="text-xs text-gray-600 dark:text-gray-400">Download the official Hyamii Desktop Printing App for direct printing</p>

                                <p class="text-sm text-gray-600 dark:text-gray-400">Watch how the Hyamii desktop application works</p>
                            </div>
...
<div class="py-10 mb-6 p-6 border rounded-lg bg-gradient-to-r from-gray-50 to-gray-50 dark:from-gray-800 dark:to-gray-800 border-gray-200 dark:border-gray-700">
                         <div class="flex items-center mb-4">
                             <div class="flex-shrink-0">
                                 <svg class="w-8 h-8 text-skin-base" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                 </svg>
                             </div>
                             <div class="ml-3">
                                 <h5 class="text-lg font-semibold text-gray-900">@lang('superadmin.whiteLabelDesktopApp')</h5>
                                 <p class="text-sm text-gray-700">@lang('superadmin.whiteLabelDesktopAppDescription')</p>
                             </div>
                         </div>

                         <div class="mb-4">
                             <h6 class="font-medium text-gray-800 mb-3">@lang('superadmin.whiteLabelFeatures')</h6>
                             <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-700">
                                 <li class="flex items-start">
                                     <svg class="w-4 h-4 text-skin-base mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                         ...
                         <div class="flex justify-center">
                             <a href="https://envato.froid.works/my-account?tab=desktop-app"
                                 target="_blank"
                                 class="inline-flex items-center justify-center px-6 py-3 bg-skin-base text-white font-medium rounded-lg hover:bg-skin-base/[.8] focus:outline-none focus:ring-2 focus:ring-skin-base focus:ring-offset-2 transition-colors">
                    ...
                    <div class="py-10 mb-6 p-6 border rounded-lg bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border-gray-200 dark:border-gray-700">
                        <div class="flex items-center mb-4">
                            <div class="flex-shrink-0">
                            ...
                            <div class="ml-3">
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-gray-100">@lang('superadmin.whiteLabelMobileApp')</h5>
                                <p class="text-sm text-gray-700 dark:text-gray-300">@lang('superadmin.whiteLabelMobileAppDescription')</p>
                            </div>
                        </div>

                        <div class="mb-4">
                            <h6 class="font-medium text-gray-800 dark:text-gray-200 mb-3">@lang('superadmin.whiteLabelFeatures')</h6>
                            <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-700 dark:text-gray-300">
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 text-gray-600 dark:text-gray-400 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    @lang('superadmin.whiteLabelFeature1')
                                </li>
