            ...
            @switch($activeTab)
                @case('prefix')
                    ...
                    <form wire:submit="saveOrderSettings" class="p-4 space-y-6 md:p-6">
                        ...
                        @if($enableFeature)
                            ...
                            <div class="mt-3">
                                ...
                                <div class="flex flex-wrap gap-4 mt-2">
                                    <label for="showYear" class="flex gap-2 items-center px-4 py-2 bg-white rounded-lg border border-gray-200 shadow-sm transition cursor-pointer dark:bg-gray-900 dark:border-gray-700 hover:border-skin-base">
                                        <x-checkbox wire:model.live="showYear" id="showYear" class="accent-skin-base" />
                                        <span class="text-gray-700 dark:text-gray-200">@lang('modules.order.showYear')</span>
                                    </label>
                                    <label for="showMonth"
                                        class="flex gap-2 items-center px-4 py-2 bg-white rounded-lg border border-gray-200 shadow-sm transition cursor-pointer dark:bg-gray-900 dark:border-gray-700 hover:border-skin-base">
                                        <x-checkbox wire:model.live="showMonth" id="showMonth" class="accent-skin-base" />
                                        <span class="text-gray-700 dark:text-gray-200">@lang('modules.order.showMonth')</span>
                                    </label>
                                    <label for="showDay" class="flex gap-2 items-center px-4 py-2 bg-white rounded-lg border border-gray-200 shadow-sm transition cursor-pointer dark:bg-gray-900 dark:border-gray-700 hover:border-skin-base">
                                        <x-checkbox wire:model.live="showDay" id="showDay" class="accent-skin-base" />
                                        <span class="text-gray-700 dark:text-gray-200">@lang('modules.order.showDay')</span>
                                    </label>
                                    <label for="showTime" class="flex gap-2 items-center px-4 py-2 bg-white rounded-lg border border-gray-200 shadow-sm transition cursor-pointer dark:bg-gray-900 dark:border-gray-700 hover:border-skin-base">
                                        <x-checkbox wire:model.live="showTime" id="showTime" class="accent-skin-base" />
                        ...
                        <!-- Preview Section -->
                        <div class="flex flex-col justify-center items-center p-4 space-y-4 bg-gray-50 rounded-2xl border-2 border-gray-200 border-dashed dark:bg-gray-950 md:p-6 dark:border-gray-700">
                            <span class="text-xl font-bold text-gray-500 dark:text-gray-400">@lang('modules.order.preview')</span>
                            <span class="font-mono text-4xl font-extrabold tracking-wider text-gray-700 dark:text-gray-400">
                                {{ $this->preview }}
                            </span>
