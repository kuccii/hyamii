<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        ...
                        <div class="relative flex space-x-3">
                            <div>
                                <span @class([
                                    ...
                                    'bg-skin-secondary' => $activity['color'] === 'purple',
                                    'bg-red-500' => $activity['color'] === 'red',
                                    'bg-yellow-500' => $activity['color'] === 'yellow',
                                    'bg-skin-base' => $activity['color'] === 'indigo'
                                ])>
    ...
    <div class="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div class="text-center">
            <div class="text-2xl font-bold text-skin-secondary">
        ...
        <div class="text-center">
            <div class="text-2xl font-bold text-skin-base">
                {{ count($recentUsers) }}
            </div>
            <div class="text-sm text-gray-500 dark:text-gray-400">
