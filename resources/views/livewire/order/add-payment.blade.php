                    ...
                    <div class="flex-1 overflow-y-auto my-4">
                        ...
                        <div x-show="splitType === 'custom'" class="h-full flex flex-col">
                            ...
                            <div class="flex-1 overflow-y-auto max-h-96 mt-2">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                @foreach($customSplits as $splitNumber)
                                    <div class="p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 shadow-sm hover:shadow-md transition-shadow hover:border-skin-secondary" wire:key="custom-split-{{ $splitNumber }}">
                                        <div class="flex items-center gap-2 mb-2.5">
                        ...
                        <div x-show="splitType === 'items'" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="p-3 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-700 rounded-lg border border-blue-200 dark:border-gray-600 shadow-sm" wire:key="items-split-info-{{ $activeSplitId }}">
