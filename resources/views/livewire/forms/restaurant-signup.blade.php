    ...
    @if ($showUserForm)
        <form wire:submit="submitForm">
            ...
            <div class="grid items-center grid-cols-1 mt-4 gap-2">
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-skin-base dark:focus:ring-offset-gray-800"
                    href="{{ route('login') }}">
