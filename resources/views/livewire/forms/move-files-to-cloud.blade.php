    ...
    <div wire:loading wire:target="moveToCloud" class="mb-6">
        <div class="relative pt-1">
            <div class="flex mb-2 items-center justify-between">
                <div>
                    <span class="text-xs font-semibold inline-block text-skin-base">
            ...
            <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-skin-base/20">
                <div 
                    style="width: {{ $progress ?? 0 }}%"
                    class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-skin-base transition-all duration-500">
                </div>
            </div>
        </div>
    </div>
