...
peer-checked:border-skin-base peer-checked:bg-skin-base/5 dark:peer-checked:bg-gray-700
                                     peer-checked:text-skin-base dark:peer-checked:text-gray-200
...
class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700
                             dark:text-gray-300 shadow-sm focus:border-skin-base focus:ring-skin-base"
                    ...
                    <div class="sm:col-span-2">
                        <div class="mt-4">
                            ...
                            <input type="text"
                                   ...
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-skin-base focus:border-skin-base sm:text-sm"
                        ...
                        <textarea id="reviewText"
                                ...
                                rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-skin-base focus:border-skin-base sm:text-sm"></textarea>
