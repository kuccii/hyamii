            ...
            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-6">
                ...
                <div class="border-t border-green-200 dark:border-green-700 pt-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="text-center">
                            <div class="text-lg font-bold text-skin-base dark:text-skin-base">{{ $uploadResults['menus_created'] }}</div>
                            <div class="text-xs text-gray-700 dark:text-gray-300">{{ __('modules.menu.menusCreated') }}</div>
                        </div>
                        @endif
                    </div>
                </div>
