...
<div class="rounded-lg border border-gray-300 bg-gray-50 p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
             <div class="text-xs uppercase tracking-wide text-gray-700 dark:text-gray-300">@lang('modules.delivery.submittedForApproval')</div>
            <div class="mt-1 text-2xl font-bold text-gray-900 dark:text-white">
