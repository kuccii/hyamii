...
{{-- Restaurant Header Section with proper spacing --}}
<section class="section-sm bg-white dark:bg-gray-950">
    <div class="container">
        ...
        <div class="flex flex-wrap items-center gap-2 mt-4 text-xs">
            @if(isset($shopBranch) && $shopBranch->address)
                <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-600 dark:text-gray-300">
            ...
            @if($restaurant->phone_number)
                <a href="tel:{{ $restaurant->phone_number }}"
                   class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
